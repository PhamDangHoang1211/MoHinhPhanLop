 ...
 */
public class AccountCashier extends javax.swing.JFrame {

    /**
     * Creates new form AccountCashier
     */
    private int id;
    public AccountCashier(int id) {
        initComponents();
        this.id=id;
    }
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String pass=txt1.getText();
            String conpass=txt2.getText();
            
            UserBLL userBLL=new UserBLL();
            if(userBLL.check(name, pass, conpass)==true)
            {
                userBLL.insertData(userBLL.getMap(id, name, pass, conpass));
                JOptionPane.showMessageDialog(null, "Succecced !!!","Welcome new Cashier ",JOptionPane.YES_OPTION);
                this.dispose();
            }
        } catch (Exception ex) {
            Logger.getLogger(AccountCashier.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountCashier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new AccountCashier(id).setVisible(true);
//            }
//        });
    }
